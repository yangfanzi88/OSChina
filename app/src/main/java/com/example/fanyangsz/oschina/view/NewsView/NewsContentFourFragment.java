 ...
 */
public class NewsContentFourFragment extends Fragment implements HttpSDK.onBlogCallBack, RefreshListView.OnRefreshListener{
    ...
    private void requestBlogs(int currentPage){
        new HttpSDK().getBlog(getActivity(), this, currentPage, BlogBeans.CATALOG_RECOMMEND);
    }
